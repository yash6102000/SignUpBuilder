  ...
  return (
    <div className="flex flex-col py-5 gap-5">
      ...
      >
        ...
        {currentAccordian === 1 ? <UpOutlined className="text-black" /> : <DownOutlined className="text-black" />}
      </div>
      {/* {position} */}
      <div  className={
            ...
            <div className="flex items-center gap-2">
              <div className="flex border border-[#D9D9D9] bg-white py-1.5 px-3 gap-6 items-center">
                ...
                <span className="flex items-center text-xs">
                  {signUpState.state.buttons.socialButtons.borderRadius>0&&signUpState.state.buttons.socialButtons.borderRadius<10?`0${signUpState.state.buttons.socialButtons.borderRadius}`:signUpState.state.buttons.socialButtons.borderRadius}
                </span>
