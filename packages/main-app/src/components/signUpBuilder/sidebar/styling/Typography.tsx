...
const Typography = () => {
  ...
  const handleNormalBoldStyle = () => {
    signUpState.setState({
      ...
      typography: {
        ...
        normalText: {
          ...signUpState.state.typography.normalText,
          bold: (signUpState.state.typography.normalText.bold =
            !signUpState.state.typography.normalText.bold),
        },
      },
    });
  };
  const handleTitleBoldStyle = () => {
    signUpState.setState({
      ...
      typography: {
        ...
        title: {
          ...signUpState.state.typography.title,
          bold: (signUpState.state.typography.title.bold =
  ...
  const handleSubTitleBoldStyle = () => {
    signUpState.setState({
      ...
      typography: {
        ...
        subTitle: {
          ...signUpState.state.typography.subTitle,
          bold: (signUpState.state.typography.subTitle.bold =
            !signUpState.state.typography.subTitle.bold),
        },
      },
    });
  };
  const handleLinksBoldFont = () => {
    signUpState.setState({
      ...
      typography: {
        ...
        links: {
          ...signUpState.state.typography.links,
          bold: (signUpState.state.typography.links.bold =
            !signUpState.state.typography.links.bold),
        },
      },
    });
  };
  ...
  return (
    <div className="p-5 pt-0 flex flex-col gap-3">
      <template>{signUpState.state.typography.fontSearchUrl}</template>
        ...
        <div className="flex flex-col border-dashed border-b border-[#0000000f] gap-2 y-4">
          ...
          <div className="flex flex-col pb-4 gap-1">
            <SelectComponent
              ...
              options={fontFamily}
            />
            <span className="text-[#00000073] text-xs">
